...
- (NSString *)getDatabasePath{
    ...
    NSString *NewPAth = [docsDir stringByAppendingPathComponent:databaseName];
    NSString *databasePathFromApp = [[[NSBundle mainBundle] resourcePath] stringByAppendingPathComponent:databaseName];
	if([[NSFileManager defaultManager] fileExistsAtPath:[docsDir stringByAppendingPathComponent:databaseName]]){
            // Already Full Path
		return NewPAth;
	} else {
        ...
        NSError *err = nil;
        [[NSFileManager defaultManager] copyItemAtPath:databasePathFromApp toPath:NewPAth error:&err];
        return NewPAth;
	}
}
/**
